//! Static Lexer
//!
//! This module contains the static lexer that is used to tokenize the source code
...
mod test {
    ...
    fn test_lexer_base() {
        ...
        let lexer = super::StaticLexer::new(rules);
        let mut result = vec![];
        // Simulate lexing
    ...
    fn test_lexer_indent_scoping_mode() {
        ...
        let mut lexer = super::StaticLexer::new(rules);
